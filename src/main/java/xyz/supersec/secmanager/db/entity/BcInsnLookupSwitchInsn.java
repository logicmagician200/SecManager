 ...
 * @since 2025-07-06
 */
@TableName("bc_insn_lookup_switch_insn")
@ApiModel(value = "BcInsnLookupSwitchInsn对象", description = "")
@Data
public class BcInsnLookupSwitchInsn implements Serializable {
